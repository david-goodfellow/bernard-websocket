...
class SessionState:
    ...
    genai_session: Optional[Any] = None  # Gemini session context manager
    active_genai_session: Optional[Any] = None  # Active Gemini session
    mcp_session: Optional[Any] = None  # MCP session for cleanup
